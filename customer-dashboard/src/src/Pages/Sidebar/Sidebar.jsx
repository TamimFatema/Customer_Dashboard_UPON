  ...
  return (
    <>
        ...
        <nav>
          <ul>
            <li className="my-3">
              ...
              >
                <span className="material-icons text-violet-700">account_circle</span>
                My Profile
              </a>
            </li>
            <li className="my-3">
            ...
            <li className="my-3">
              <a href="#" className="flex items-center gap-5 font-semibold hover:text-[#8B087E] focus:text-[#8B087E]">
                <span className="material-icons text-[#8B087E]">
                  mail
                </span>
                Inbox
              </a>
      ...
      <div className="relative w-full md:w-[750px] mx-auto lg:hidden bg-white rounded-lg flex justify-between items-center p-4">
        ...
        <span onClick={() => toggleShowSidebar(true)} className="material-symbols-outlined cursor-pointer bg-purple-600 text-white rounded-md p-1">
          menu
        </span>
        {showSideBar && <nav className="absolute top-0 right-0 bg-white p-4 rounded-tr-lg border">
          <span onClick={() => toggleShowSidebar(false)} className="material-symbols-outlined cursor-pointer text-blue-500">
            close
          </span>
          <ul>
            <li className="my-3">
