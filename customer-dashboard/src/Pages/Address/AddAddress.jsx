...
function AddAddress() {
  ...
  const countries = [{ value: "bangladesh", label: "Bangladesh" }];
    ...
    <form className="w-full md:w-[750px] mx-auto lg:mx-0 bg-white p-5 rounded-lg">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm">
          ...
          <div className="flex gap-10">
            <div className="flex flex-col items-center">
              <span
                ...
                className={`material-symbols-outlined cursor-pointer border-2 rounded-full p-1 ${
                  label == "home" ? "bg-[#5709BB] text-white" : "text-[#5709BB]"
                }  border-[#5709BB] `}
              >
                home
              </span>
            ...
            <div className="flex flex-col items-center">
              <span
                ...
                className={`material-symbols-outlined cursor-pointer border-2 rounded-full p-1 ${
                  label == "work" ? "bg-[#5709BB] text-white" : "text-[#5709BB]"
                }  border-[#5709BB] `}
              >
                work
              </span>
        ...
        <div className="sm:col-span-2 grid sm:grid-rows-4 sm:grid-flow-col gap-5">
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="countrydropdown" className="font-medium">
              Country
            </label>
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="zipcodedropdown" className="font-medium">
              Zip Code
            </label>
            <select
              id="zipcodedropdown"
